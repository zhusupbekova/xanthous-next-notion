...
export const authorsData = [
  {
    id: 'alexzhao',
    name: 'Alex Zhao',
    avatar: require('./avatars/alex.jpeg'),
    title: 'author.alexzhao.title',
    bio: 'author.alexzhao.bio',
    location: 'country.china',
    profile_image: require('./img/alex-knight-326705-unsplash.jpg'),
  },
  {
    id: 'necmttn',
    name: 'Necmettin Karakaya',
    avatar: require('./avatars/neco_profile.jpg'),
    twitter: 'necmttn',
    facebook: 'necmettin.karakaya',
    github: 'necmttn',
    title: 'author.necmttn.title',
    bio: 'author.necmttn.bio',
    location: 'country.thailand',
    profile_image: require('./img/NK-logo.png'),
  },
  {
    id: 'osmanmesutozcan',
    name: 'Osman Mesut Ozcan',
    avatar: require('./avatars/osman.jpg'),
    title: 'author.osmanmesutozcan.title',
    bio: 'author.osmanmesutozcan.bio',
  ...
  },
  {
    id: 'simonliang',
    name: 'Simon Liang',
    avatar: require('./avatars/simonliang.jpg'),
    title: 'author.simonliang.title',
    bio: 'author.simonliang.bio',
    location: 'country.china',
    profile_image: require('./img/speeches-cover.jpg'),
  },
  {
    id: 'zhusupbekova',
    name: 'Alina Zhusupbekova',
    avatar: require('./avatars/simonliang.jpg'),
    title: 'author.zhusupbekova.title',
    bio: 'author.zhusupbekova.bio',
    location: 'country.china',
    profile_image: require('./img/speeches-cover.jpg'),
  },
]
