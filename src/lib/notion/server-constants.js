...
const PROJECT_INDEX_ID = normalizeId(process.env.PROJECT_INDEX_ID)
const ZH_BLOG_INDEX_ID = normalizeId(process.env.ZH_BLOG_INDEX_ID)
const ZH_PROJECT_INDEX_ID = normalizeId(process.env.ZH_PROJECT_INDEX_ID)
